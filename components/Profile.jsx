...
const Profile = () => {
  ...
  const handleDownloadCV = () => {
    window.open('./assets/mijaisha resume.pdf');
  };
  ...
  const handleLinkedInClick = () => {
    window.location.href = 'https://linkedin.com/in/mijaisha-v-s';
  };
  ...
  return (
    <section id="profile">
      <div className="section__pic-container" border-radius="50%">
        <img src="./assets/my_img.jpeg" alt='mijaisha'  />
      </div>
      <div className="section__text">
        <p className="section__text__p1">Hello, I'm</p>
        <h1 className="title">MIJAISHA V S</h1>
